...
LORAS = {4: os.getenv("LORA_4STEP", "minimax_h3_fl2v_turbo_4step_v1.0_768p_comfyui_bf16.safetensors"),
         8: os.getenv("LORA_8STEP", "minimax_h3_fl2v_turbo_8step_v1.0_comfyui_bf16.safetensors")}
            ...
            for out in outputs.values():
                for f in out.get("gifs", []) + out.get("videos", []) + out.get("images", []):
                    if f.get("filename", "").lower().endswith(".mp4"):
                        ...
                        return {"video": base64.b64encode(data).decode(), "filename": f["filename"],
